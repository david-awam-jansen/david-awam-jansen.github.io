...
<ul>
<li> -   keep in a 'save' format </li>
<li> -   Preferably not excel format - transferring between platforms can cause an issue (e.g. dates) </li>
<li> -   csv, tsv, maybe text <li/>
</ul>

<li> -   Don't make changes to this raw data </li>
...
<ul>
  ...
  <li>Information does generally not change
    <ul>
...
## Data documentation xx (2) {.smaller}
...
- **README**
    ...
    - [UC Irvine README guide](https://guides.lib.uci.edu/datamanagement/readme)  
    :::
...
<ul>
   ...
   <li>   **No spaces !!** </li>
   <li>   Case-sensitive (e.g. R) versus case insensitive (SQL) <li>
   <li>   R (and many other languages) names can't start with numbers </li>
   <li>   'car speed in miles per hour' versus 'car speed (mph)' versus **car_speed_mph**' </li>
</ul>
